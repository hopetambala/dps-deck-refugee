...
issue](https://github.com/hopetambala/dps-deck-refugee/issues) before anybody
...
Short answer: with pull requests to the dps-deck-refugee repository.

All decisions affecting dps-deck-refugee follow the same 3 steps:
...
* 2) Be available to anyone with questions, bug reports, criticism etc. on dps-deck-refugee.
